...
input spaces. For this purpose, we extend the generative adversarial networks
...
instances, while preserving the separation between classes. Experimental results
demonstrate the potential of this novative approach to transfer learning. More
fundamentally, this paradigm also raises interesting theoretical issues, since
such transformations may not always be unique nor necessarily grounded,
depending on the studied problem.
