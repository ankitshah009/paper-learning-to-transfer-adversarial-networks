...
Transfer learning, and its variants such as learning under covariate shift or
...
raises new theoretical issues, since transformations $T$  may not
be unique nor all grounded, yet we seek only the one making most sense.
